...
DialogOSGBToS3MB::DialogOSGBToS3MB(QWidget *parent)
	: QDialog(parent)
{
...
void DialogOSGBToS3MB::handleTextEditedEvent()
{
...
void DialogOSGBToS3MB::handleThreadFinishedEvent()
{
...
void DialogOSGBToS3MB::handleConfirmButtonClickedEvent()
{
	...
	OSGBParams* pParam = new OSGBParams();
...
void DialogOSGBToS3MB::handleCancelButtonClickedEvent()
{
	this->close();
}

void DialogOSGBToS3MB::handleSrcFileButtonClickedEvent()
{
...
void DialogOSGBToS3MB::handleDesFileButtonClickedEvent()
{
    QFileDialog* pFileSelectDialog = new QFileDialog(this);
    pFileSelectDialog->setWindowTitle(codec->toUnicode("打开"));
