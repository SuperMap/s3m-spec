...
//#if  _MSC_VER > 1200
//	case enrPVRTPF_PVRTC2:
//	{
//		//编码成pvr2
//		unsigned __int64 ulPixelFormat = 0x0808080861626772;  //字符RGBA8888
//		//pvrtexture::CPVRTextureHeader pvrHeader(ulPixelFormat, nHeight, nWidth, 1, nMipmapCount);
//		//pvrtexture::CPVRTexture cTexture(pvrHeader, pMipmapBuffer);
//
//		//pvrtexture::Transcode(cTexture, ePVRTPF_PVRTCII_2bpp, ePVRTVarTypeUnsignedByteNorm, ePVRTCSpacelRGB, pvrtexture::ePVRTCFast);
//		pvr::TextureHeader pvrHeader(ulPixelFormat, nHeight, nWidth, 1, nMipmapCount);
//		pvr::Texture cTexture(pvrHeader, pMipmapBuffer);
//		pvr::BufferStream stream;
//
//		unsigned char *pGeneBuffer = (unsigned char *)cTexture.getDataPtr();
//		nCompressedSize = cTexture.getDataSize();
//		//由于无法事先预知buffer大小，故内部分配空间
//		*ppBufferOut = new unsigned char[nCompressedSize];
//		::memcpy((*ppBufferOut), pGeneBuffer, nCompressedSize);
//	}
//	break;
//	case enrPVRTPF_ETC1:
//	{
...
//		pvrtexture::CPVRTexture cTexture(pvrHeader, pMipmapBuffer);
//
//		pvrtexture::Transcode(cTexture, ePVRTPF_ETC1, ePVRTVarTypeUnsignedByteNorm, ePVRTCSpacelRGB, pvrtexture::eETCFastPerceptual);
//
//		unsigned char *pGeneBuffer = (unsigned char *)cTexture.getDataPtr();
//		nCompressedSize = cTexture.getDataSize();
//		//由于无法事先预知buffer大小，故内部分配空间
...
//	}
//	break;
//	case enrPVRTPF_PVRTC:
//	case enrPVRTPF_PVRTC_FAST:
//	{
//		//编码成pvr1
//		unsigned __int64 ulPixelFormat = 0x0808080861626772;  //字符RGBA8888
//		//pvrtc一代不支持小于8*8的mipmap纹理 wangxinhe
//		if (nMipmapCount > 3)
//		{
//			nMipmapCount -= 3;
//		}
//		pvrtexture::CPVRTextureHeader pvrHeader(ulPixelFormat, nWidth, nHeight, 1, nMipmapCount);
//		pvrtexture::CPVRTexture cTexture(pvrHeader, pMipmapBuffer);
//		if (nPixSize == 3)
//		{
//			pvrtexture::Transcode(cTexture, ePVRTPF_PVRTCI_2bpp_RGB, ePVRTVarTypeUnsignedByteNorm, ePVRTCSpacelRGB, (eCodecType == enrPVRTPF_PVRTC) ? (pvrtexture::ePVRTCNormal) : (pvrtexture::ePVRTCFast));
//		}
//		else
//		{
//			pvrtexture::Transcode(cTexture, ePVRTPF_PVRTCI_2bpp_RGBA, ePVRTVarTypeUnsignedByteNorm, ePVRTCSpacelRGB, (eCodecType == enrPVRTPF_PVRTC) ? (pvrtexture::ePVRTCNormal) : (pvrtexture::ePVRTCFast));
//		}
//
//		unsigned char *pGeneBuffer = (unsigned char *)cTexture.getDataPtr();
//		nCompressedSize = cTexture.getDataSize();
...
//	case enrPVRTPF_ETC1:
//	{
//		//精细纹理是从原始数据里解压出来的，mipmap是后生成的，速度不比解压慢，而且避免了原始数据不包含mipmap的尴尬
//
//		unsigned int eFormat = GetPVRPixelFormat(eCodecType, nPixSize);
//		pvrtexture::ECompressorQuality eQuality = pvrtexture::ePVRTCNormal;
//		if (eCodecType == enrPVRTPF_ETC1)
//		{
//			eQuality = pvrtexture::eETCFastPerceptual;
//		}
//
//		pvrtexture::CPVRTextureHeader pvrHeader(eFormat, nHeight, nWidth);
//		pvrtexture::CPVRTexture cTexture(pvrHeader, pBufferIn);
//		pvrtexture::Transcode(cTexture, pvrtexture::PVRStandard8PixelType, ePVRTVarTypeUnsignedByteNorm, ePVRTCSpacelRGB, eQuality);
//
//		unsigned char *pBuffer = (unsigned char *)cTexture.getDataPtr();
//		unsigned int nPvrSize = cTexture.getDataSize();
//
//		//生成mipmap
//		if (bGeneMipmaps)
//		{
//			unsigned char *pGenMipMap = NULL;
//			vector<unsigned int> arrOffset;
//			nSizeOut = ImageOperator::GetMipMapData(nWidth, nHeight, pBuffer, &pGenMipMap, arrOffset);
//			*ppBufferOut = new unsigned char[nSizeOut];
//			::memcpy(*ppBufferOut, pGenMipMap, nSizeOut);
//
//			delete[]pGenMipMap;
...
//			nSizeOut = nPvrSize;
//			*ppBufferOut = new unsigned char[nSizeOut];
//			::memcpy(*ppBufferOut, pBuffer, nSizeOut);
//		}
//		break;
//	}
//#endif
...
//#if _MSC_VER > 1200
//unsigned int ImageOperator::GetPVRPixelFormat(unsigned int eCodecType, unsigned int nComponent)
//{
//	EPVRTPixelFormat eFormat = ePVRTPF_PVRTCI_4bpp_RGBA;
//	switch (eCodecType)
//	{
//	case CodecType::enrPVRTPF_PVRTC2:
//		eFormat = ePVRTPF_PVRTCI_4bpp_RGBA;
//		break;
//	case CodecType::enrPVRTPF_PVRTC:
//	case CodecType::enrPVRTPF_PVRTC_FAST:
//	{
//		if (nComponent == 3)
//		{
//			eFormat = ePVRTPF_PVRTCI_2bpp_RGB;
//		}
//		else
//		{
//			eFormat = ePVRTPF_PVRTCI_2bpp_RGBA;
//		}
//	}
//	break;
//	case CodecType::enrPVRTPF_ETC1:
//		eFormat = ePVRTPF_ETC1;
//		break;
//	default:
//		break;
//	}
...
bool ImgToolkit::JpgToBuffer(string filePath, TextureData*& pTextureData, unsigned int &bufferSize, unsigned char*& pBits, int& format, bool bReverse /*= true*/)
{
...
bool ImgToolkit::PngToBuffer(string filePath, TextureData*& pTextureData, unsigned int &BufferSize, unsigned char*& pBits, int& format, Palette& palette, bool bReverse /*= true*/)
{
	FILE* m_File = (FILE*)fopen(filePath.c_str(), "rb");
	if (m_File == NULL)
	{
...
bool ImgToolkit::GDALToBuffer(string filePath, TextureData*& pTextureData, unsigned int &BufferSize, unsigned char*& pBits, int& format, Palette& palette, bool bReverse /*= true*/)
{
...
bool ImgToolkit::BufferToTextureData(TextureData*& pTextureData, unsigned int BitsSize, unsigned char*& pBits, int format, Palette palette)
{
