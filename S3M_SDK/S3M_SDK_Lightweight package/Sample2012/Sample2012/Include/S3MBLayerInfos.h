...
#define S3MB_JSON_Z								    "z"
	...
	public:
		...
		//从Json文件中加载属性值
		static bool AttributeDataFromJson(std::map<uInt, Feature*>& mapFeature, JsonValue& jsonValue);
		...
		static bool IsIDExisted(std::map<uInt, Feature*>& mapFeature, int nBeginID, int nEndID);
		//读取FieldInfos
