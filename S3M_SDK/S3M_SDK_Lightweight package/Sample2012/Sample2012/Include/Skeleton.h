...
public:
	...
	//顶点维数
	USHORT m_nVertexDimension;
	//顶点偏移
	USHORT m_nVertexStride;
	//顶点数组
	T* m_pVertices;
	//! \brief 顶点各分量的最小值
	...
	UINT m_nNormalCount;
	//法线维数
	USHORT m_nNormalDimension;
	//法线偏移
	USHORT m_nNormalStride;
	//法线数组
	float* m_pNormals;

	//顶点颜色个数
	UINT m_nVertexColorCount;
	//顶点颜色偏移
	USHORT m_nVertexColorStride;
	//顶点颜色数组
	UINT* m_pVertexColor;

	//顶点第二颜色个数
	UINT m_nSecondVertexColorCount;
	//顶点第二颜色偏移
	USHORT m_nSecondVertexColorStride;
	//顶点第二颜色数组
	UINT* m_pSecondVertexColor;

	//贴图坐标数目
	UINT m_TexCoordCount[SMSCN_MAX_TEXTURE_COORD_SETS];

	//贴图坐标的维数
	USHORT m_nTexDimensions[SMSCN_MAX_TEXTURE_COORD_SETS];

	//每组贴图坐标的Stride
	USHORT m_TexCoordStride[SMSCN_MAX_TEXTURE_COORD_SETS];
