...
public:
	...
	static bool JpgToBuffer(string filePath, TextureData*& pTextureData, uInt &bufferSize, unsigned char*& pBits,int& format, bool bReverse = true);
	static bool PngToBuffer(string filePath, TextureData*& pTextureData, uInt &BufferSize, unsigned char*& pBits, int& format,Palette& palette,bool bReverse = true);
	static bool GDALToBuffer(string filePath, TextureData*& pTextureData, uInt &BufferSize, unsigned char*& pBits, int& format, Palette& palette, bool bReverse = true);
	static bool BufferToTextureData(TextureData*& pTextureData, uInt bufferSize, unsigned char*& pBits, int format,Palette palette);
	//===================================================
	//! \brief  通过位深得到jpg像素格式
